...
class App extends Component {
  ...
  render() {
    ...
    const loginOrOut = this.state.isSignedIn ? (
      <FiLogOut onClick={this.signOut} />
    ) : (
      <FiLogIn />
    );
    return (
        ...
        <div id="page-wrap">
            ...
            <nav style={navStyles}>
              <li>
                <Link className="link-nav" to="/">
                  <img className="nav-img" src={kosovoImg} />
                </Link>
              </li>
              <li>
                <Link className="link-nav" to="/activities">
                  Things to See and Do
                </Link>
              </li>
              <li>
                <Link className="link-nav" to="most-popular">
                  Most Popular
                </Link>
              </li>
              <li>
          ...
          <Switch>
            ...
            <Route
              ...
              render={props => (
                <Reviews isSignedIn={this.state.isSignedIn} {...props} />
              )}
            />
            <Route
              exact
              path="/activity/:id/reviews"
              render={props => (
                <ReviewForm isSignedIn={this.state.isSignedIn} {...props} />
              )}
            />
            <Route
              exact
